### Original code from James Ruppert. Edited by Colin Welty 
# Code that utilizes interpolated relative vorticity to track the storm center, with settings for smoothing and masking. 
# Outputs the track to a netCDF file.
# Utilizes track_tc.py
# 
#  Most recent edit: 15 Jun 2026
...
# Choices
ptrack  = 800 # tracking pressure level
istorm = 'erin'
i_senstest = False
var_tag = 'rvor'
basis = 0
...
print("Successfully read in the pressure variables.")
# Read in lat/lon
...
lat1d=lat[:,0]
# Read in interpolated file data
